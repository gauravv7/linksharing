                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <a class="text-right" style="display: block">view post</a>
                                    </div>
                                </div>
                            </div>
                        </div> <!-- row -->
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" class="form-control" name="confirmPassword" id="confirmPassword" placeholder="confirmPassword">
                                        </div>
                                    </div>
                                    <div class="form-group">
